...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if(num_dice == 0):
            if who == 0:
                temp_score = picky_piggy(score1)
            else:
                temp_score = picky_piggy(score0)
        else:
           temp_score =  roll_dice(num_dice,dice)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(*scores):
        ...
        if gain > running_high:
            ...
            return announce_highest(who, scores[who], gain)#you aren't normally allowed to modify variables defined in parent frames
    ...
    #     assert len(scores) == 2
    #     gain = scores[who] - last_score 
    #     if gain > running_high1:
    #         print(f"{gain} point(s)! That's a record gain for Player {who}!")
    #         running_high1 = gain
    #     return announce_highest(who, scores[who], running_high1)
    # return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def try_and_average(*args):
        ...
        return sum(res) / trials_count#badly puzzled
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    return trials.index(max(trials)) + 1#badly brain damaged 
    # END PROBLEM 9
...
def picky_piggy_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_piggy = picky_piggy(opponent_score)
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score_roll_zero = picky_piggy(opponent_score)
    score_roll_zero += score
    if score_roll_zero == opponent_score:
        score_roll_zero *= 2

    if score_roll_zero - score >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
