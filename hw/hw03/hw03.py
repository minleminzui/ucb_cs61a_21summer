...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == 'loki':
        ...
        return tree(label(t), [replace_loki_at_leaf(branche, lokis_replacement) for branche in branches(t)])
...
def mul_interval(x, y):
    ...
    p4 = upper_bound(y) * lower_bound(x)
...
def quadratic(x, a, b, c):
    ...
    r = upper_bound(x)
    extreme_point = -b / (2 * a)
    if (2*a*l + b) * (2*a*r + b) < 0:
        if a > 0:
            return interval((a*extreme_point*extreme_point + b*extreme_point + c), \
                max((a*l*l + b*l + c), (a*r*r + b*r + c)))
        else:
            return interval(min((a*l*l + b*l + c), (a*r*r + b*r + c)), \
                 (a*extreme_point*extreme_point + b*extreme_point + c))
    elif 2*a*l + b < 0:
